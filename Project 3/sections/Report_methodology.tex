...
\[
	\begin{bmatrix}[1.5]
		...
		0 & \dots & 0 & \frac{1}{2} \Sigma^m_{s12} \delta r + \frac{1}{2} \Sigma^R_{s12} \delta r_R  & 0 & \dots \\
...
\[
	\begin{bmatrix}[1.5]
		\frac{1}{2} \left( \Sigma^m_{s12} + \Sigma^m_{s23}   & 0 & 0 & 0 & \dots\\
		0 & \Sigma^m_{s12}  & 0 & 0 & \dots & \dots \\
		0 & 0 & \Sigma^m_{s12}  & 0 & 0 & \dots\\
		0 & \dots & 0 & \frac{1}{2} \Sigma^m_{s12} \delta r + \frac{1}{2} \Sigma^R_{s12} \delta r_R  & 0 & \dots \\
		\dots & 0 & 0 & 0 & \Sigma^R_{s12}  & 0 \\
		\dots & 0 & 0 & 0 & \dots & \Sigma^R_{s12} \\
	\end{bmatrix}
	\]
