...
The interface node is where the reactor core and reflector meet.  This means contributions from both materials must be accounted for.  The following finite-difference equation is derived for this special case:
